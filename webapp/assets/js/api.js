const API = (() => {
  ...
  return {
    ...
    battleBetaActive: () => call('battle_beta_active.php'),
    battleBetaRoom: (roomId) => call(`battle_beta_room.php?roomId=${roomId}`),
    battleBetaSelectClass: (roomId, classKey) => call('battle_beta_select_class.php', { method: 'POST', body: { roomId, classKey } }),
    battleBetaReady: (roomId, ready) => call('battle_beta_ready.php', { method: 'POST', body: { roomId, ready } }),
    battleBetaStart: (roomId) => call('battle_beta_start.php', { method: 'POST', body: { roomId } }),
    battleBetaState: (roomId) => call(`battle_beta_state.php?roomId=${roomId}`),
    battleBetaAnswer: (roomId, selected) => call('battle_beta_answer.php', { method: 'POST', body: { roomId, selected } }),
    battleBetaLeave: (roomId) => call('battle_beta_leave.php', { method: 'POST', body: { roomId } }),
    battleBetaKick: (roomId, userId) => call('battle_beta_kick.php', { method: 'POST', body: { roomId, userId } }),
    battleBetaEnd: (roomId) => call('battle_beta_end.php', { method: 'POST', body: { roomId } }),
    battleBetaQuit: (roomId) => call('battle_beta_quit.php', { method: 'POST', body: { roomId } }),
    exhibitionCreate: (topicIds) => call('exhibition_create.php', { method: 'POST', body: { topicIds } }),
    exhibitionJoin: (code) => call('exhibition_join.php', { method: 'POST', body: { code } }),
    exhibitionVote: (sessionId, topicId) => call('exhibition_vote.php', { method: 'POST', body: { sessionId, topicId } }),
    exhibitionLobbyState: (sessionId) => call(`exhibition_lobby_state.php?sessionId=${sessionId}`),
    exhibitionFinalize: (sessionId) => call('exhibition_finalize.php', { method: 'POST', body: { sessionId } }),
    exhibitionStartAttempt: (sessionId) => call('exhibition_start_attempt.php', { method: 'POST', body: { sessionId } }),
    exhibitionClose: (sessionId) => call('exhibition_close.php', { method: 'POST', body: { sessionId } }),
