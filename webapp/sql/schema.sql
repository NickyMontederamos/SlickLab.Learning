...
-- Spellfire Beta: a fully separate clone of the battle_* tables above, for
-- an experimental class/milestone game mode. See migration_16.sql for why
-- every class ability here is self-targeted only (no cross-player state).
